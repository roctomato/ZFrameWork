...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp11(UnityEngine.Transform p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(ScrollView.CellUpdateDelegate))
			{
			    return new ScrollView.CellUpdateDelegate(__Gen_Delegate_Imp11);
			}
